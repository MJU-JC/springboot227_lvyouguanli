<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="购票编号" prop="goupiaobianhao">
            <el-input v-model="ruleForm.goupiaobianhao" 
                placeholder="购票编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.goupiaobianhao" label="购票编号" prop="goupiaobianhao">
              <el-input v-model="ruleForm.goupiaobianhao" 
                placeholder="购票编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="购票详情" prop="goupiaoxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.goupiaoxiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.goupiaoxiangqing" label="购票详情" prop="goupiaoxiangqing">
                    <span v-html="ruleForm.goupiaoxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='goupiaobianhao'){
            this.ruleForm.goupiaobianhao = obj[o];
	    this.ro.goupiaobianhao = true;
            continue;
          }
	    ...
	    this.ro.goupiaoshijian = true;
          ...
          if(o=='goupiaoxiangqing'){
            this.ruleForm.goupiaoxiangqing = obj[o];
	    this.ro.goupiaoxiangqing = true;
            continue;
          }
          if(o=='yonghuzhanghao'){
	...
	this.ruleForm.goupiaoxiangqing = this.ruleForm.goupiaoxiangqing.replace(reg,'../../../springboot99u10/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
