    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="旅游路线" prop="lvyouluxian">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.lvyouluxian" label="旅游路线" prop="lvyouluxian">
                    <span>{{ruleForm.lvyouluxian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.jingdianxiangqing = this.ruleForm.jingdianxiangqing.replace(reg,'../../../springboot99u10/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
